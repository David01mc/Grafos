# app.py - Servidor Flask Profesional con Soporte para Imágenes
...
def init_db():
    ...
    # Tabla de personas - CON SOPORTE PARA IMÁGENES
    cursor.execute('''
    ...
    try:
        ...
        for persona in personas:
            ...
            if persona['imagen_url']:
                ...
                node_data['size'] = 80  # Tamaño mayor para nodos con imagen
...
def agregar_persona():
    """Formulario para agregar nueva persona - CON SOPORTE PARA IMÁGENES"""
...
def eliminar_persona(persona_id):
    ...
    persona = conn.execute('SELECT nombre, imagen_url FROM personas WHERE id = ?', (persona_id,)).fetchone()
...
def guardar_posiciones():
    """Guardar posiciones de los nodos"""
    data = request.get_json()
